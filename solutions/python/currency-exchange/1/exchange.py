...
def get_leftover_of_bills(amount, denomination):
    ...
    exchanged_money = get_value_of_bills(denomination, number_of_bills)
    return amount - exchanged_money
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    num_of_bills = get_number_of_bills(exchanged_money, denomination)
    return get_value_of_bills(denomination, num_of_bills)
