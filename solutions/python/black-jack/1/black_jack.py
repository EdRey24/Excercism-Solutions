...
def is_blackjack(card_one, card_two):
    ...
    card_one_is_ten = card_one == '10' or card_one == 'J' or card_one == 'Q' or card_one == 'K'
    card_two_is_ten = card_two == '10' or card_two == 'J' or card_two == 'Q' or card_two == 'K'

    return ace_in_hand and (card_one_is_ten or card_two_is_ten)
